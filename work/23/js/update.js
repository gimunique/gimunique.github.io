...
function initSizeSetting() {
    ...
    $(".wrap, .section").css({"height": windowHeight});

    if (windowWidth > 1920) {
        $(".section .bg").css({"margin-left": -(windowWidth / 2)}).addClass("cover");
        $(".wrap").css({"width": windowWidth * SetValueInfo.sectionLength});
        ...
        $(".wrap").css({"width": SetValueInfo.sectionWidth * SetValueInfo.sectionLength});
        $(".section").css({"width": SetValueInfo.sectionWidth});
